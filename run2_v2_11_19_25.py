...
wait(500)
# ready to turn left to leave the flag
drive_base.settings(100)
drive_base.curve(130,95)
# (130.93)
wait(400)
drive_base.settings(400)
...
drive_base.turn(-17)
#following 3 lines used to use lalipop to hit basket. but now no need
...
while True:
    ...
    #print('1st step')
    reflection = color_sensor.reflection()   
    print('2nd', reflection)

    if reflection <= 15: 
        print('2nd new', reflection)
        drive_base.settings(straight_speed = 600)
        drive_base.stop
        break
yaw4=prime_hub.imu.heading()
print('the current heading yaw4 is', yaw4)
rightattach.run_angle(850,60)
# drive_base.turn(-90)
# leftattach.run_angle(1000, -80)
# drive_base.straight(-200)

# #under dino now
# leftattach.run_angle(200,50)
