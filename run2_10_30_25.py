...
#the initial position is the right end of the robot in the middle of the 10th light square; 
#sometimes marked with a lego piece
...
drive_base.turn(-80)
drive_base.straight(615)
wait(500)
drive_base.settings(100)
drive_base.curve(130,100)
wait(400)
drive_base.settings(400)
